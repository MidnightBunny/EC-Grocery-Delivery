...
?>
<?php 
            $q1=mysqli_query($open_connection,"SELECT *  FROM tbl_category");
            $q2=mysqli_query($open_connection,"SELECT *  FROM tbl_products");
            $q3=mysqli_query($open_connection,"SELECT *  FROM tbl_supplier");
            $q4=mysqli_query($open_connection,"SELECT *  FROM tbl_user");
            $q5=mysqli_query($open_connection,"SELECT *  FROM tbl_customer"); 

            $a1=mysqli_num_rows($q1);
            $a2=mysqli_num_rows($q2);
            $a3=mysqli_num_rows($q3);
            $a4=mysqli_num_rows($q4);
            $a5=mysqli_num_rows($q5);
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><strong><span style="font-size: 35px;"><?php echo $a2," "; ?></span></strong></div>
                                    <div>Inventory</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><strong><span style="font-size: 35px;"><?php echo $a3," "; ?></span></strong></div>
                                    <div>Suppliers</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><strong><span style="font-size: 35px;"><?php echo $a1," "; ?></span></strong></div>
                                    <div>Category</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><strong><span style="font-size: 35px;"><?php echo $a4," "; ?></span></strong></div>
                                    <div>Users</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-danger">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><strong><span style="font-size: 35px;"><?php echo $a5," "; ?></span></strong></div>
                                    <div>Customers</div>
                                </div>
                            </div>
                        </div>
