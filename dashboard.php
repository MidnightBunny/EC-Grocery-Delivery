        ...
        <div class="panel panel-danger">
          ...
          <div class="panel-body">
            <?php 
              ...
              $q2=mysqli_query($open_connection,"SELECT *  FROM tbl_subcategory");
              $q3=mysqli_query($open_connection,"SELECT *  FROM tbl_supplier");
              $q4=mysqli_query($open_connection,"SELECT *  FROM tbl_products");
              //$q5=mysqli_query($open_connection,"SELECT *  FROM tbl_orders");
              $a1=mysqli_num_rows($q1);
              $a2=mysqli_num_rows($q2);
              $a3=mysqli_num_rows($q3);
              $a4=mysqli_num_rows($q4);
            ?>
            <button class="btn btn-success"><?php echo $a1," "; ?>Categories</button>
            <button class="btn btn-primary"><?php echo $a2," "; ?> Sub Categories</button>
            <button class="btn btn-primary"><?php echo $a3," "; ?>Suppliers</button>
            <button class="btn btn-primary"><?php echo $a4," "; ?>Products</button>
          </div>
